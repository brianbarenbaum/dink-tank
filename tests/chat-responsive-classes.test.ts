...
describe("chat responsive layout", () => {
  ...
  it("allows desktop sidebar collapse and reopen", async () => {
    ...
    expect(wrapper.get("[data-testid='desktop-sidebar-close-icon']").attributes("title")).toBe(
      "Collapse sidebar",
    );
    expect(wrapper.get("[data-testid='desktop-sidebar-close-icon']").classes()).toContain(
      "cursor-pointer",
    );
    expect(wrapper.get("[data-testid='desktop-new-chat']").text()).toContain("New Chat");
    expect(wrapper.get("[data-testid='desktop-new-chat']").classes()).not.toContain("border");
    expect(wrapper.get("[data-testid='desktop-new-chat']").classes()).not.toContain("uppercase");
    ...
    expect(wrapper.find("[data-testid='desktop-rail-new-chat']").exists()).toBe(true);
    expect(wrapper.get("[data-testid='desktop-sidebar-rail']").classes()).toContain("lg:flex-col");
    expect(wrapper.get("[data-testid='desktop-sidebar-open-icon']").attributes("title")).toBe(
      "Expand sidebar",
    );
    expect(wrapper.get("[data-testid='desktop-rail-new-chat']").attributes("title")).toBe(
      "New chat",
    );
